...
?>
        ...
        <div class="animated fadeIn">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form name="fomr1" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="form-group"> <img src="<?php echo $opt1; ?>" height="50" width="50" > <br> <label for="company" class=" form-control-label">Add Option 1</label><input type="file" class="form-control" name="fopt1" style="padding-bottom:35px"></div>
                                        <div class="form-group"> <img src="<?php echo $opt2; ?>" height="50" width="50" > <br> <label for="company" class=" form-control-label">Add Option 2</label><input type="file" class="form-control" name="fopt2" style="padding-bottom:35px"></div>
                                        <div class="form-group"> <img src="<?php echo $opt3; ?>" height="50" width="50" > <br> <label for="company" class=" form-control-label">Add Option 3</label><input type="file" class="form-control" name="fopt3" style="padding-bottom:35px"></div>
                                        <div class="form-group"> <img src="<?php echo $opt4; ?>" height="50" width="50" > <br> <label for="company" class=" form-control-label">Add Option 4</label><input type="file" class="form-control" name="fopt4" style="padding-bottom:35px"></div>
                                        <div class="form-group"> <img src="<?php echo $answer; ?>" height="50" width="50" > <br> <label for="company" class=" form-control-label">Add Answer</label><input type="file" class="form-control" name="fanswer" style="padding-bottom:35px"></div>
    ...
    if(isset($_POST["submit2"]))
    {
        ...
        if($opt1!="")
        {
                ...
                $dst_db1="opt_images/" . $tm . $opt1;       //storing image
        ...
        if($opt2!="")
        {
                ...
                $dst_db2="opt_images/" . $tm . $opt2;       //storing image
        ...
        if($opt3!="")
        {
                ...
                $dst_db3="opt_images/" . $tm . $opt3;       //storing image
        ...
        if($opt4!="")
        {
                ...
                $dst_db4="opt_images/" . $tm . $opt4;       //storing image
        ...
        if($answer!="")
        {
                ...
                $dst_db5="opt_images/" . $tm . $answer;       //storing image
